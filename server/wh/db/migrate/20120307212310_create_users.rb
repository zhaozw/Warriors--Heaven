...
=begin
    ...
    insert into users values(NULL, "monkey",    "b88f4175ebdee8be89f50d12d7ddb5f3", 30, 1, "新人",     6, NULL, NULL);
    insert into users values(NULL, "king",      "f0a28ae6cc681d3f50ae4f281cab9218", 30, 1, "大侠",     7, NULL, NULL);
    insert into users values(NULL, "queen",     "1320346951bf2bc6293fb70cc2a71a05", 30, 1, "女侠",     0, NULL, NULL);
